...
//                clip.setContent(null);
        ...
        private function _createNetStream():void {
            _netStream = createNetStream(_connection) ||
				new RadarNetStream(
					_connection,
					//"http://radar-server.jakewan.com/customers/01-10050-radarStreaming.xml",
					"http://radar.cedexis.com/01-10660-radarStreaming.xml",
					log.debug);
            netStream.client = new NetStreamClient(clip, _player.config, _streamCallbacks);
